...
<html>
	...
	<body class="w3-light-grey">
		...
		<form class="w3-container" method="post">
            ...
            <button class="w3-btn w3-hover-light-blue w3-margin-right w3-round-medium" type="submit">Найти организацию</button>
		</form>
		</div>
			...
			<table class="w3-table-all">				
				<%
					...
					if (organizations != null && !organizations.isEmpty()) {
					    ...
					    out.println("<tr><h2 class=\"w3-hover-sand\"><b> Организации не найдены </b></h2></tr>");
					}
				%>
			</table>
		</div>
